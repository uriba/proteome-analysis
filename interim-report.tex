...
Other directions are: constructing a gross cellular physiology model to address various physiological questions, asses the effects of different ribosomal control mechanisms on their expected cellular content, model population dynamics in the microbiome based on recent meta-genomic data from the Segal lab, characterize possible metabolic network motifs based on the concavity of reaction kinetics functions, and investigating theoretical bounds on chemical reaction rates and efficiencies.
}
\clearpage        
\tableofcontents
\clearpage        

...
\begin{itemize}
\item Construct central dogma and major components in-scilico model and use to analyze sensitivities and identify dominant factors in the proteome.
\item Use turbidostats and proteomics to assess changes in the proteome across conditions and nutrient levels both to track monod curves and to extend our current work.
\item Check various optimal ribosomes concentration values as functions of different effects and figure out which fits experimental observations.

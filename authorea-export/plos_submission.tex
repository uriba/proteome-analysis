...
\paragraph{Databases omitted from the main analysis}
...
\subsection{S4 Text}
\label{corrthreshold} 
\paragraph{Threshold selection for defining strong correlation with growth rate}
...
\caption{
The fraction out of the proteome of proteins that are not differentially regulated between conditions can be predicted by referencing other such proteins.
...
\caption{
Ribosomal proteins scale similarly to non-ribosomal proteins that are strongly positively correlated with growth rate.
...
\subsection{S9 Text}
\paragraph{Additional figures of simulated and randomized data sets}

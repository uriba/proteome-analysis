...
Nonetheless, many such mechanisms have been shown to exist \cite{Nomura1984,Scott2014} (for a comparison to the models suggested in \cite{Scott2010,Scott2014} and \cite{Hui_2015} see \nameref{scottcompare}).
...
{\bf Datasets omitted from the main analysis}
...
\subsection*{S4 text}
\label{corrthreshold} 
{\bf Threshold choice for defining strong correlation with growth rate}
...
\subsection*{S6 text}
\label{lbanalysis}
{\bf Analysis of the data set from Schmidt et. al. including fast growth conditions}
...
\subsection*{S9 text}
\label{scottcompare}
{\bf Comparison of the passive resource allocation model to the sections model from Scott et. al.}
In \cite{Scott2010,Scott2014} and \cite{Hui_2015}, a sectioning model of the proteome is presented.

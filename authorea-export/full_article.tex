...
Studies examining the interplay between global and specific modes of regulation, suggested that global factors play a major role in determining the expression levels of genes \cite{Gasch2000,Klumpp2009,Klumpp2014,Scott2010,Scott2014,Berthoumieux2013,Keren2013,Gerosa2013,Valgepea2013,Hui_2015,Weise2015}.
...
Nonetheless, many such mechanisms have been shown to exist \cite{Nomura1984,Scott2014} (for a comparison to the models suggested in \cite{Scott2010,Scott2014} and \cite{Hui_2015} see \ref{scottcompare}).
...
\subsection{Datasets omitted from the main analysis}
...
\subsection{Threshold choice for defining strong correlation with growth rate}
\label{corrthreshold} 
...
\subsection{Analysis of the data set from Schmidt et. al. including fast growth conditions}
\label{lbanalysis}
...
\subsection{Comparison of the passive resource allocation model to the sections model from Scott et. al.}
\label{scottcompare}
In \cite{Scott2010,Scott2014,Hui_2015}, a sectioning model of the proteome is presented.
...
To summarize, where the models from \cite{Scott2010,Scott2014} and \cite{Hui_2015} focus on what classes of proteins exist, what are the master regulators, and how are they used to achieve optimal growth, the model presented here focuses on global patterns that passively emerge due to specific regulation on specific genes (be it regulation that is targeted at only a small number of genes, or a large group of genes), exposing the fact that positive correlation of protein fraction with growth rate can be an emerging property, not requiring active regulation of the positively correlated proteins.

...
\begin{document}
%%% ron's comments: before histograms present one graph of a characteristic protein to give insight to pearson correlation.
%%% give some visualization to model.
%%% add legend to demo graph

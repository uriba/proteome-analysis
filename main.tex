...
\footnote{Proteins with unknown function (present in the Heinemann data set, right panel) show less correlation with growth rate, as well as proteins with low levels of expression (data not shown).}
}
\label{fig:growthcorr}
\end{figure}

Next, we checked how large is the response of the proteins that have a significant positive correlation\footnote{Significan correlation was defined as a correlation above 0.8 for the V data set and a correlation in the range (0.4,0.8) for the H data set} with the growth rate across the conditions measured.
...
Furthermore, the highly correlated proteins form a large fraction of the proteome mass-wise, approaching or exceding $50\%$ of the proteome at the higher growth rates measured.
...
\caption{
The sum of the concentrations of the highly correlated proteins\footnote{Highly correlated proteins were defined as having a correlation above 0.8 for the V data set and a correlation in the range (0.4,0.8) for the H data set} in each of the data sets (with linear regression lines) is shown.

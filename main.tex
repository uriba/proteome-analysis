...
Furthermore, we show how the resulting growth rate can be an outcome of the change in the proteome composition suggesting that proteome composition, combined with specific environmental conditions, determines the growth rate.
}
